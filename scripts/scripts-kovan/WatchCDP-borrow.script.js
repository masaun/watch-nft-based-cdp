...
async function checkWstBalanceInAdvance() {
    let _wstBalanceOfBorrower = await watchSignalsToken.balanceOf(borrower)
    let wstBalanceOfBorrower = web3.utils.fromWei(String(_wstBalanceOfBorrower), 'ether')
